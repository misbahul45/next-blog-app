...
const Input = ({ type, placeholder, register, id, name }:Props) => {
  ...
  return (
    <div className='relative'>
      ...
      id={id}
      name={name}
      className="peer block w-full pl-3 py-2.5 shadow-md shadow-slate-500 rounded-md bg-late-300 mb-5 outline-none focus:ring-2 focus:ring-blue-700 invalid:focus:ring-red-600"
      />
